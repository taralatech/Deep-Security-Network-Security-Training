...
$virtualnetwork = New-AzVirtualNetwork -Name $virtualnetworkname -ResourceGroupName $resourcegroupname -Location $location -AddressPrefix "10.10.0.0/16" -Subnet $frontendSubnet,$backendSubnet
